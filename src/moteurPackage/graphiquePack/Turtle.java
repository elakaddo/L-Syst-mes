...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    private static void init()
    {
        ...
        window = new JFrame("Projet conception L-Système");
        icon = new ImageIcon();
        setupBuffering();
        ...
        menuBar.add(menu);
        JMenuItem menuItem1 = new JMenuItem("Enregistrer-sous...");
 ...
 */
   ...
   /**
    ...
    {
        if(((JMenuItem)e.getSource()).getText().equals("Enregistrer-sous..."))
        {
